        """
        Schema Enforcer Yrbev3
        ======================
        Open-source data utility that enrichs tabular data across multiple formats.
...
from pathlib import Path
        ...
        APP_NAME    = "Schema Enforcer Yrbev3"
        APP_VERSION = "1.0.0"
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source data utility that enrichs tabular data across multiple formats.")
